...
describe("App", () => {
  ...
  it("resets the saved session when clicking the resume banner reset button and confirming", async () => {
    const savedFormData = {
      partyAName: "Alice",
      partyBName: "Bob",
    };
    ...
    // Click the initial reset button to open dialog
    fireEvent.click(resetButton);

    // Dialog should appear
    expect(await screen.findByText(/Reset Form Data\?/i)).toBeInTheDocument();
