...
export const SmartSuggestions = ({
  ...
  // Use debounced value to prevent excessive "API calls"
  ...
  useEffect(() => {
    // Only trigger if we have a field type and enough characters
    // Using debouncedValue instead of currentValue to reduce API calls
