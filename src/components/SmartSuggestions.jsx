...
export const SmartSuggestions = ({
  ...
  // Debounce the value to prevent excessive updates while typing
  // Reduced to 300ms since we removed the artificial delay
  ...
  const suggestions = useMemo(() => {
    ...
    let generatedSuggestions = SUGGESTIONS_DATA[fieldType] || [];
