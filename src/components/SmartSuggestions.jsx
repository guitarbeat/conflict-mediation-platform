  ...
  return (
    <div className={cn("space-y-2", className)}>
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                disabled={isLoading}
                className="p-1 text-muted-foreground hover:text-foreground transition-colors disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-sm"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button
                ...
                className="p-1 text-muted-foreground hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-sm"
      ...
      {showSuggestions && (
        <div
          id={suggestionsId}
          className="space-y-1 animate-in slide-in-from-top-1 fade-in duration-200"
        >
          {isLoading ? (
            <div className="flex items-center gap-2 text-sm text-muted-foreground">
